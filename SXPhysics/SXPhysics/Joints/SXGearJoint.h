...
@property (nonatomic, strong) SXJoint* joint1; // TO DO: maybe retain and release onExit

// The second revolute/prismatic joint attached to the gear joint.
@property (nonatomic, strong) SXJoint* joint2; // TO DO: maybe retain and release onExit
